...
app = FastAPI(title="Risk Agent Service", version="1.0.0")
...
def get_agent():
    ...
    if _agent is None:
        ...
        from src.trading_system.sub_agents import RiskAgent
        config = LLMConfig(
        ...
        _agent = RiskAgent(LLMService(config))
...
def run(req: RunRequest):
    try:
        ...
        logger.exception("Error running RiskAgent")
