...
app = FastAPI(title="Analysis Agent Service", version="1.0.0")
...
def get_agent():
    ...
    if _agent is None:
        ...
        from src.trading_system.sub_agents import AnalysisAgent
        config = LLMConfig(
        ...
        _agent = AnalysisAgent(LLMService(config))
...
def run(req: RunRequest):
    try:
        ...
        logger.exception("Error running AnalysisAgent")
